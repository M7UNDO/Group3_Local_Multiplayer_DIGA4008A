...
public class StackManager : MonoBehaviour
{
    ...
    private void PerformStack(PlayerStackInfo bottomPlayer, PlayerStackInfo topPlayer)
    {
        ...
        StartCoroutine(PlaySmokeThenShowMeshes(currentStackedCharacter, "MagicPoof", stackSFX));
    ...
    private IEnumerator PlaySmokeThenShowMeshes(GameObject obj, string particleName, AudioSource sfx = null)
    {
        ...
        if (triggerPS != null)
            delay = triggerPS.main.startDelay.constant + 0.05f;
    ...
    public void Unstack()
    {
        ...
        if (stackedBottomPlayer.playerObject != null)
        {
            ...
            StartCoroutine(PlaySmokeThenShowMeshes(stackedBottomPlayer.playerObject, "HitSmoke", unstackSFX));
        }
        ...
        if (stackedTopPlayer.playerObject != null)
        {
            ...
            StartCoroutine(PlaySmokeThenShowMeshes(stackedTopPlayer.playerObject, "HitSmoke", unstackSFX));
        }
